...
# Cálculos resumen y visualización gráfica de las temperaturas medias diarias para la serie historica y reciente campaña de grano grueso
#-----------------------------------------------------------------------------------
...
bce_18_19 <- # Fusionar serie con campaña 18/19
  bce %>%
...
# Visualizar la Tmean en la serie (con sus bandas de 80-percentil), y valores  por década de la última campaña
